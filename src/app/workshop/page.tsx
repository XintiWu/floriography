...
import { WorkshopStudio } from "@/components/workshop/WorkshopStudio";
    ...
    <main className="flex-1 animate-fade-in">
      ...
      <div className="relative overflow-hidden border-b border-[color:var(--line)]">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--line)_1px,_transparent_1px)] [background-size:24px_24px] opacity-30" />
        ...
        <Container className="py-12 sm:py-14">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <p className="text-sm leading-7 text-[color:var(--muted)]">
              自由混搭底紙、花卉素材與燙金字句，親手設計具備專屬溫度的植感獻禮。
            </p>
          </div>
        </Container>
      </div>
